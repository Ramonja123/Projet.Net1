        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responsables_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factures_Paniers_PanierId",
                        column: x => x.PanierId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationChambres_Paniers_PanierId",
                        column: x => x.PanierId,
                        principalTable: "Paniers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationServices_Paniers_PanierId",
                        column: x => x.PanierId,
                        principalTable: "Paniers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationChambres_ClientId",
                table: "ReservationChambres",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationChambres_PanierId",
                table: "ReservationChambres",
                column: "PanierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationServices_PanierId",
                table: "ReservationServices",
                column: "PanierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responsables_ApplicationUserId",
                table: "Responsables",
                column: "ApplicationUserId",
                unique: true);
        }
